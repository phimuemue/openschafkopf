...
fn test_rulesfarbwenz() {
    test_rules(
        ...
        &SRulesSoloLike::<SCoreGenericWenz<STrumpfDeciderFarbe<SFarbeDesignatorGras>>>::new(3, /*i_prioindex*/-1, "Gras-Wenz"),
    ...
    test_rules(
        ...
        &SRulesSoloLike::<SCoreGenericWenz<STrumpfDeciderFarbe<SFarbeDesignatorHerz>>>::new(0, /*i_prioindex*/-1, "Herz-Wenz"),
    ...
    test_rules(
        ...
        &SRulesSoloLike::<SCoreGenericWenz<STrumpfDeciderFarbe<SFarbeDesignatorHerz>>>::new(1, /*i_prioindex*/-1, "Herz-Wenz"),
    ...
    test_rules(
        ...
        &SRulesSoloLike::<SCoreGenericWenz<STrumpfDeciderFarbe<SFarbeDesignatorGras>>>::new(0, /*i_prioindex*/-1, "Gras-Wenz"),
    ...
    test_rules(
        ...
        &SRulesSoloLike::<SCoreGenericWenz<STrumpfDeciderFarbe<SFarbeDesignatorGras>>>::new(2, /*i_prioindex*/-1, "Gras-Wenz"),
    ...
    test_rules(
        ...
        &SRulesSoloLike::<SCoreGenericWenz<STrumpfDeciderFarbe<SFarbeDesignatorEichel>>>::new(3, /*i_prioindex*/-1, "Eichel-Wenz"),
    ...
    test_rules(
        ...
        &SRulesSoloLike::<SCoreGenericWenz<STrumpfDeciderFarbe<SFarbeDesignatorEichel>>>::new(0, /*i_prioindex*/-1, "Eichel-Wenz"),
...
fn test_ruleswenz() {
    test_rules(
        ...
        &SRulesSoloLike::<SCoreGenericWenz<STrumpfDeciderNoTrumpf>>::new(0, /*i_prioindex*/-1, "Wenz"),
    ...
    test_rules(
        ...
        &SRulesSoloLike::<SCoreGenericWenz<STrumpfDeciderNoTrumpf>>::new(3, /*i_prioindex*/-1, "Wenz"),
    ...
    test_rules(
        ...
        &SRulesSoloLike::<SCoreGenericWenz<STrumpfDeciderNoTrumpf>>::new(2, /*i_prioindex*/-1, "Wenz"),
    ...
    test_rules(
        ...
        &SRulesSoloLike::<SCoreGenericWenz<STrumpfDeciderNoTrumpf>>::new(1, /*i_prioindex*/-1, "Wenz"),
...
fn test_rulessolo() {
    test_rules(
        ...
        &SRulesSoloLike::<SCoreSolo<STrumpfDeciderFarbe<SFarbeDesignatorGras>>>::new(0, /*i_prioindex*/-1, "Gras-Solo"),
    ...
    test_rules(
        ...
        &SRulesSoloLike::<SCoreSolo<STrumpfDeciderFarbe<SFarbeDesignatorEichel>>>::new(0, /*i_prioindex*/-1, "Eichel-Solo"),
    ...
    test_rules(
        ...
        &SRulesSoloLike::<SCoreSolo<STrumpfDeciderFarbe<SFarbeDesignatorGras>>>::new(2, /*i_prioindex*/-1, "Gras-Solo"),
    ...
    test_rules(
        ...
        &SRulesSoloLike::<SCoreSolo<STrumpfDeciderFarbe<SFarbeDesignatorHerz>>>::new(0, /*i_prioindex*/-1, "Herz-Solo"),
    ...
    test_rules(
        ...
        &SRulesSoloLike::<SCoreSolo<STrumpfDeciderFarbe<SFarbeDesignatorEichel>>>::new(3, /*i_prioindex*/-1, "Eichel-Solo"),
    ...
    test_rules(
        ...
        &SRulesSoloLike::<SCoreSolo<STrumpfDeciderFarbe<SFarbeDesignatorHerz>>>::new(3, /*i_prioindex*/-1, "Herz-Solo"),
    ...
    test_rules(
        ...
        &SRulesSoloLike::<SCoreSolo<STrumpfDeciderFarbe<SFarbeDesignatorHerz>>>::new(2, /*i_prioindex*/-1, "Herz-Solo"),
    ...
    test_rules(
        ...
        &SRulesSoloLike::<SCoreSolo<STrumpfDeciderFarbe<SFarbeDesignatorEichel>>>::new(2, /*i_prioindex*/-1, "Eichel-Solo"),
    ...
    test_rules(
        ...
        &SRulesSoloLike::<SCoreSolo<STrumpfDeciderFarbe<SFarbeDesignatorEichel>>>::new(1, /*i_prioindex*/-1, "Eichel-Solo"),
    ...
    test_rules(
        ...
        &SRulesSoloLike::<SCoreSolo<STrumpfDeciderFarbe<SFarbeDesignatorGras>>>::new(1, /*i_prioindex*/-1, "Gras-Solo"),
    ...
    test_rules(
        ...
        &SRulesSoloLike::<SCoreSolo<STrumpfDeciderFarbe<SFarbeDesignatorHerz>>>::new(1, /*i_prioindex*/-1, "Herz-Solo"),
    ...
    test_rules(
        ...
        &SRulesSoloLike::<SCoreSolo<STrumpfDeciderFarbe<SFarbeDesignatorGras>>>::new(3, /*i_prioindex*/-1, "Gras-Solo"),
...
fn test_rulesgeier() {
    test_rules(
        ...
        &SRulesSoloLike::<SCoreGenericGeier<STrumpfDeciderNoTrumpf>>::new(2, /*i_prioindex*/-1, "Geier"),
    ...
    test_rules(
        ...
        &SRulesSoloLike::<SCoreGenericGeier<STrumpfDeciderNoTrumpf>>::new(0, /*i_prioindex*/-1, "Geier"),
    ...
    test_rules(
        ...
        &SRulesSoloLike::<SCoreGenericGeier<STrumpfDeciderNoTrumpf>>::new(3, /*i_prioindex*/-1, "Geier"),
    ...
    test_rules(
        ...
        &SRulesSoloLike::<SCoreGenericGeier<STrumpfDeciderNoTrumpf>>::new(1, /*i_prioindex*/-1, "Geier"),
