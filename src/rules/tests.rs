...
fn test_rulesfarbwenz() {
    test_rules(
        ...
        &SRulesActiveSinglePlay::<SCoreGenericWenz<STrumpfDeciderFarbe<SFarbeDesignatorGras>>>::new(3, /*i_prioindex*/-1, "Gras-Wenz"),
    ...
    test_rules(
        ...
        &SRulesActiveSinglePlay::<SCoreGenericWenz<STrumpfDeciderFarbe<SFarbeDesignatorHerz>>>::new(0, /*i_prioindex*/-1, "Herz-Wenz"),
    ...
    test_rules(
        ...
        &SRulesActiveSinglePlay::<SCoreGenericWenz<STrumpfDeciderFarbe<SFarbeDesignatorHerz>>>::new(1, /*i_prioindex*/-1, "Herz-Wenz"),
    ...
    test_rules(
        ...
        &SRulesActiveSinglePlay::<SCoreGenericWenz<STrumpfDeciderFarbe<SFarbeDesignatorGras>>>::new(0, /*i_prioindex*/-1, "Gras-Wenz"),
    ...
    test_rules(
        ...
        &SRulesActiveSinglePlay::<SCoreGenericWenz<STrumpfDeciderFarbe<SFarbeDesignatorGras>>>::new(2, /*i_prioindex*/-1, "Gras-Wenz"),
    ...
    test_rules(
        ...
        &SRulesActiveSinglePlay::<SCoreGenericWenz<STrumpfDeciderFarbe<SFarbeDesignatorEichel>>>::new(3, /*i_prioindex*/-1, "Eichel-Wenz"),
    ...
    test_rules(
        ...
        [-200, -200, 600, -200], // TODO Doppeln
    );
    test_rules(
        "../../testdata/games/farbwenz/9.html",
        &SRulesActiveSinglePlay::<SCoreGenericWenz<STrumpfDeciderFarbe<SFarbeDesignatorEichel>>>::new(0, /*i_prioindex*/-1, "Eichel-Wenz"),
...
fn test_ruleswenz() {
    test_rules(
        ...
        &SRulesActiveSinglePlay::<SCoreGenericWenz<STrumpfDeciderNoTrumpf>>::new(0, /*i_prioindex*/-1, "Wenz"),
    ...
    test_rules(
        ...
        &SRulesActiveSinglePlay::<SCoreGenericWenz<STrumpfDeciderNoTrumpf>>::new(3, /*i_prioindex*/-1, "Wenz"),
    ...
    test_rules(
        ...
        &SRulesActiveSinglePlay::<SCoreGenericWenz<STrumpfDeciderNoTrumpf>>::new(2, /*i_prioindex*/-1, "Wenz"),
    ...
    test_rules(
        ...
        &SRulesActiveSinglePlay::<SCoreGenericWenz<STrumpfDeciderNoTrumpf>>::new(1, /*i_prioindex*/-1, "Wenz"),
...
fn test_rulessolo() {
    test_rules(
        ...
        &SRulesActiveSinglePlay::<SCoreSolo<STrumpfDeciderFarbe<SFarbeDesignatorGras>>>::new(0, /*i_prioindex*/-1, "Gras-Solo"),
    ...
    test_rules(
        ...
        &SRulesActiveSinglePlay::<SCoreSolo<STrumpfDeciderFarbe<SFarbeDesignatorEichel>>>::new(0, /*i_prioindex*/-1, "Eichel-Solo"),
    ...
    test_rules(
        ...
        &SRulesActiveSinglePlay::<SCoreSolo<STrumpfDeciderFarbe<SFarbeDesignatorGras>>>::new(2, /*i_prioindex*/-1, "Gras-Solo"),
    ...
    test_rules(
        ...
        &SRulesActiveSinglePlay::<SCoreSolo<STrumpfDeciderFarbe<SFarbeDesignatorHerz>>>::new(0, /*i_prioindex*/-1, "Herz-Solo"),
    ...
    test_rules(
        ...
        &SRulesActiveSinglePlay::<SCoreSolo<STrumpfDeciderFarbe<SFarbeDesignatorEichel>>>::new(3, /*i_prioindex*/-1, "Eichel-Solo"),
    ...
    test_rules(
        ...
        &SRulesActiveSinglePlay::<SCoreSolo<STrumpfDeciderFarbe<SFarbeDesignatorHerz>>>::new(3, /*i_prioindex*/-1, "Herz-Solo"),
    ...
    test_rules(
        ...
        &SRulesActiveSinglePlay::<SCoreSolo<STrumpfDeciderFarbe<SFarbeDesignatorHerz>>>::new(2, /*i_prioindex*/-1, "Herz-Solo"),
    ...
    test_rules(
        ...
        &SRulesActiveSinglePlay::<SCoreSolo<STrumpfDeciderFarbe<SFarbeDesignatorEichel>>>::new(2, /*i_prioindex*/-1, "Eichel-Solo"),
    ...
    test_rules(
        ...
        &SRulesActiveSinglePlay::<SCoreSolo<STrumpfDeciderFarbe<SFarbeDesignatorEichel>>>::new(1, /*i_prioindex*/-1, "Eichel-Solo"),
    ...
    test_rules(
        ...
        &SRulesActiveSinglePlay::<SCoreSolo<STrumpfDeciderFarbe<SFarbeDesignatorGras>>>::new(1, /*i_prioindex*/-1, "Gras-Solo"),
    ...
    test_rules(
        ...
        &SRulesActiveSinglePlay::<SCoreSolo<STrumpfDeciderFarbe<SFarbeDesignatorHerz>>>::new(1, /*i_prioindex*/-1, "Herz-Solo"),
    ...
    test_rules(
        ...
        &SRulesActiveSinglePlay::<SCoreSolo<STrumpfDeciderFarbe<SFarbeDesignatorGras>>>::new(3, /*i_prioindex*/-1, "Gras-Solo"),
...
fn test_rulesgeier() {
    test_rules(
        ...
        &SRulesActiveSinglePlay::<SCoreGenericGeier<STrumpfDeciderNoTrumpf>>::new(2, /*i_prioindex*/-1, "Geier"),
    ...
    test_rules(
        ...
        &SRulesActiveSinglePlay::<SCoreGenericGeier<STrumpfDeciderNoTrumpf>>::new(0, /*i_prioindex*/-1, "Geier"),
    ...
    test_rules(
        ...
        &SRulesActiveSinglePlay::<SCoreGenericGeier<STrumpfDeciderNoTrumpf>>::new(3, /*i_prioindex*/-1, "Geier"),
    ...
    test_rules(
        ...
        [150, -50, -50, -50], // TODO Doppeln // TODO Adjust Laufende
    );
    ...
    test_rules(
        ...
        &SRulesActiveSinglePlay::<SCoreGenericGeier<STrumpfDeciderNoTrumpf>>::new(1, /*i_prioindex*/-1, "Geier"),
