...
fn sololike<CoreType>(eplayerindex: EPlayerIndex, str_rulename: &str) -> Box<TRules> 
...
fn test_rulessolo() {
    ...
    // "../../testdata/games/solo/21-gras-solo.html", // TODO kurze Karte
    test_rules(
    ...
    test_rules(
        ...
        // "../../testdata/games/solo/20-gras-solo.html", // TODO kurze Karte
    test_rules(
