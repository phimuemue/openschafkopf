...
pub fn get_rules(clapmatches: &clap::ArgMatches) -> Result<Box<dyn crate::rules::TRules>, Error> {
    crate::rules::parser::parse_rule_description_simple(unwrap!(clapmatches.value_of("rules")))
}
