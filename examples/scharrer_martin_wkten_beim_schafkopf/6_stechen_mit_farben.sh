...
./target/release/openschafkopf hand-stats --simulate-hands $N_SIMULATE_HANDS --rules "herz-solo von 0" \
    ...
    --inspect "/*Der Spieler mit der Eichel-Zehn hat nur 1 Eichel*/ ctx.eichel(ctx.who_has_ez())==1"
...
./target/release/openschafkopf hand-stats --simulate-hands $N_SIMULATE_HANDS --rules "herz-solo von 0" \
    ...
    --inspect "/*Der Spieler mit der Eichel-Zehn und mit Eichel-Koenig haben je nur 1 Eichel*/ ctx.eichel(ctx.who_has_ez())==1 && ctx.eichel(ctx.who_has_ek())==1"
