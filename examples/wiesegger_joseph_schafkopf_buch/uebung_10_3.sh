...
./target/release/openschafkopf suggest-card --rules "Eichel-Wenz von 2" --played-cards "ha hk ea h8  gu ez eu e7  sk s7 ek sa  su g7 e8 hu" --hand "ga gk go g8" --simulate-hands all --branching "9,9" --verbose --points --snapshotcache
...
do
    ...
    ./target/release/openschafkopf suggest-card \
        ...
        --played-cards "ha hk ea h8  gu ez eu e7  sk s7 ek sa  su g7 e8 hu $card" \
        --hand "eo e9 gz g9" \
...
./target/release/openschafkopf suggest-card \
    --rules "Eichel-Wenz von 2" \
    --played-cards "ha hk ea h8  gu ez eu e7  sk s7 ek sa  su g7 e8 hu" \
    --hand "eo e9 gz g9" \
    --points \
