...
./target/release/openschafkopf suggest-card --rules "Rufspiel mit der Gras-Sau von 0" --played-cards "HO HK H7 GO  GZ G9 GA G8  EU H8 GU HU  S7 S8 SK SA  EA E9 H9 EK  GK E8" --hand "SO EZ SU" --branching "9,9" --simulate-hands all
