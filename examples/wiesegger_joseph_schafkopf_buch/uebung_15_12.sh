...
./target/release/openschafkopf hand-stats --rules "Eichel-Solo von 2" --hand "eo so hu ez ek ha hk h9" --simulate-hands 1000000 --inspect "0<h(1)&&0<h(2)&&0<h(3)"
...
./target/release/openschafkopf hand-stats --rules "Eichel-Solo von 2" --hand "eo so hu ez ek ha hk h9" --cards-on-table "h7 h8" --simulate-hands 1000000 --inspect "h(3)"
