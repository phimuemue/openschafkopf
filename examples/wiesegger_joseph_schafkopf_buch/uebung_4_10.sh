...
./target/release/openschafkopf suggest-card --rules "eichel solo von 0" --cards-on-table "e8 ea hu su  sa hk ez s7  e9 eu e7 gu  sk sz eo" --hand "go so ek ga gz" --simulate-hands all --branching equiv7 --constrain-hands '!ho(3)'

echo "Above analysis shows that SO and EK lead to same payouts, but we can observe that point-wise, SO is the better choice:"
./target/release/openschafkopf suggest-card --rules "eichel solo von 0" --cards-on-table "e8 ea hu su  sa hk ez s7  e9 eu e7 gu  sk sz eo" --hand "go so ek ga gz" --simulate-hands all --branching equiv7 --constrain-hands '!ho(3)' --points
