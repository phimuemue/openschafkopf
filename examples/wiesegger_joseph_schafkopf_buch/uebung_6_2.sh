...
./target/release/openschafkopf suggest-card --rules "Wenz von 1" --cards-on-table "ga gu g7 s7  eu s9 h8 su  sa h7 s8 sz  ea ek eo e8" --hand "ha hz h9 ez" --branching "9,9" --simulate-hands all --constrain-hands '0==ctx.eichel(0)'
